...
function InfinitiveWordVerb(props) {
        ...
        <View>
            ...
            <FormBlockWrapper boxType='infinitive'>
                ...
                <View style={styles.POSContainer}>
                    ...
                    <View style={{ backgroundColor: 'white', borderRadius: 5, marginTop: 3 }}><Text style={styles.POSTexts}>{props.binyan}</Text></View>
                </View>
            </FormBlockWrapper>
        </View>
    );
...
export default InfinitiveWordVerb;
