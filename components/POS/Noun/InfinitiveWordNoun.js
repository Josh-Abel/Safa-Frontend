...
function InfinitiveWordNoun(props) {
        ...
        <View>
            ...
            <FormBlockWrapper boxType='infinitive'>
                ...
                <View style={styles.POSContainer}>
                    <View style={{ backgroundColor: 'white', borderRadius: 5, marginBottom: 3 }}><Text style={styles.POSTexts}>{props.pos}</Text></View>
                    <View style={{ backgroundColor: 'white', borderRadius: 5, marginTop: 3 }}><Text style={styles.POSTexts}>{props.gender}</Text></View>
                </View>
            </FormBlockWrapper>
        </View>
    );
...
export default InfinitiveWordNoun;
