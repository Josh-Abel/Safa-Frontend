        ...
        <View>
            ...
            <View style={styles.conjugationColumnsContainer}>
                <View style={{ flexDirection: 'row-reverse' }}>
                    <View>
                        <View style={styles.pronounContainer}>
                            <View><Text style={styles.pronounText}>אני</Text></View>
                            <View><Text style={styles.pronounText}>אתה</Text></View>
                            <View><Text style={styles.pronounText}>הוא</Text></View>
                        </View>
                        <View style={styles.pronounContainer}>
                            <View><Text style={styles.pronounText}>אני</Text></View>
                            <View><Text style={styles.pronounText}>את</Text></View>
                ...
                <View style={{ flexDirection: 'row-reverse' }}>
                    <View>
                        <View style={styles.pronounContainer}>
                            <View><Text style={styles.pronounText}>אנחנו</Text></View>
                            <View><Text style={styles.pronounText}>אתם</Text></View>
                            <View><Text style={styles.pronounText}>הם</Text></View>
                        </View>
                        <View style={styles.pronounContainer}>
                            <View><Text style={styles.pronounText}>אנחנו</Text></View>
                            <View><Text style={styles.pronounText}>אתן</Text></View>
